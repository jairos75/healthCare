...
import 'package:healthcare/widgets/app_bar/appbar_leading_image.dart';
import 'package:healthcare/widgets/app_bar/appbar_subtitle.dart';
import 'package:healthcare/widgets/app_bar/appbar_trailing_image.dart';
import 'package:healthcare/widgets/app_bar/custom_app_bar.dart';
import 'package:healthcare/widgets/custom_elevated_button.dart';
import 'package:healthcare/widgets/custom_icon_button.dart';
import 'package:healthcare/widgets/custom_rating_bar.dart';
...
class DrugDetailsScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => DrugDetailsProvider(), child: DrugDetailsScreen());
  }
}
...
class DrugDetailsScreenState extends State<DrugDetailsScreen> {
  ...
  /// Section Widget
  Widget _buildDrugDetails(BuildContext context) {
